...
class TrashController extends Controller
{
    ...
    private $models = [
        'karyawan' => [
            ...
            ['id', 'nama', 'email', 'deleted_at']
        ],
        'jabatan' => [
            'Jabatan',
            \App\Models\Jabatan::class,
            ['id', 'nama', 'deleted_at']
        ],
        'cuti' => [
            'Cuti',
            \App\Models\Cuti::class,
            ['id', 'user_id', 'nama_cuti', 'status', 'deleted_at']
        ],
        'absensi' => [
            'Absensi',
            \App\Models\Absensi::class,
            ['id', 'user_id', 'tanggal', 'status', 'deleted_at']
        ],
        'izin' => [
            'Izin',
            \App\Models\Izin::class,
            ['id', 'user_id', 'tanggal', 'jenis_izin', 'deleted_at']
        ],
        'sakit' => [
            'Sakit',
            \App\Models\Sakit::class,
            ['id', 'user_id', 'diagnosa', 'deleted_at']
        ],
        'lembur' => [
            'Lembur',
            \App\Models\Lembur::class,
            ['id', 'user_id', 'upah_lembur_per_jam', 'deleted_at']
        ],
        'people_development' => [
            'People Development',
            \App\Models\PeopleDevelopment::class,
            ['id', 'user_id', 'jabatan', 'deleted_at']
        ],
        'development_kpi' => [
            'Development KPI',
            \App\Models\DevelopmentKpi::class,
            ['id', 'kpi', 'status', 'deleted_at']
        ],
        'development_objective' => [
            'Development Objective',
            \App\Models\DevelopmentObjective::class,
            ['id', 'objective', 'deleted_at']
        ],
        'gaji_bulanan' => [
            'Gaji Bulanan',
            \App\Models\GajiBulanan::class,
            ['id', 'user_id', 'gaji_bulanan', 'deleted_at']
        ],
        'gaji_harian' => [
            'Gaji Harian',
            \App\Models\GajiHarian::class,
            ['id', 'user_id', 'gaji_harian', 'deleted_at']
        ],
        'penggajian' => [
            'Penggajian',
            \App\Models\Penggajian::class,
            ['id', 'user_id', 'periode_mulai', 'gaji_diterima', 'deleted_at']
        ],
        'lokasi' => [
            'Lokasi',
            \App\Models\Lokasi::class,
            ['id', 'nama', 'radius', 'deleted_at']
        ],
        'kalender' => [
            'Kalender',
            \App\Models\Kalender::class,
            ['id', 'tanggal', 'keterangan', 'deleted_at']
        ],
        'hak_cuti' => [
            'Hak Cuti',
            \App\Models\HakCuti::class,
            ['id', 'hak_cuti', 'deleted_at']
        ],
        'absensi_sales' => [
            'Absensi Sales',
            \App\Models\AbsensiSales::class,
            ['id', 'user_id', 'tanggal', 'status_persetujuan', 'deleted_at']
        ],
        'permintaan_lembur' => [
            'Permintaan Lembur',
            \App\Models\PermintaanLembur::class,
            ['id', 'user_id', 'tugas', 'status', 'deleted_at']
        ],
        'status_karyawan' => [
            'Status Karyawan',
            \App\Models\StatusKaryawan::class,
            ['id', 'status_karyawan', 'deleted_at']
        ],
    ];

    // Daftar kolom yang akan ditampilkan (versi rapi dan singkat)
    private $displayColumns = [
        'Karyawan' => ['id', 'nama', 'email', 'deleted_at'],
        'Jabatan' => ['id', 'nama', 'deleted_at'],
        'Cuti' => ['id', 'user_id', 'nama_cuti', 'status', 'deleted_at'],
        'Absensi' => ['id', 'user_id', 'tanggal', 'status', 'deleted_at'],
        'Izin' => ['id', 'user_id', 'tanggal', 'jenis_izin', 'deleted_at'],
        'Sakit' => ['id', 'user_id', 'diagnosa', 'deleted_at'],
        'Lembur' => ['id', 'user_id', 'upah_lembur_per_jam', 'deleted_at'],
        'People Development' => ['id', 'user_id', 'jabatan', 'deleted_at'],
        'Development KPI' => ['id', 'kpi', 'status', 'deleted_at'],
        'Development Objective' => ['id', 'objective', 'deleted_at'],
        'Gaji Bulanan' => ['id', 'user_id', 'gaji_bulanan', 'deleted_at'],
        'Gaji Harian' => ['id', 'user_id', 'gaji_harian', 'deleted_at'],
        'Penggajian' => ['id', 'user_id', 'periode_mulai', 'gaji_diterima', 'deleted_at'],
        'Lokasi' => ['id', 'nama', 'radius', 'deleted_at'],
        'Kalender' => ['id', 'tanggal', 'keterangan', 'deleted_at'],
        'Hak Cuti' => ['id', 'hak_cuti', 'deleted_at'],
        'Absensi Sales' => ['id', 'user_id', 'tanggal', 'status_persetujuan', 'deleted_at'],
        'Permintaan Lembur' => ['id', 'user_id', 'tugas', 'status', 'deleted_at'],
        'Status Karyawan' => ['id', 'status_karyawan', 'deleted_at'],
    ];
    ...
    {
        $modelKey = $request->query('model'); // e.g., 'people_development'
    ...
    public function restore(Request $request, $model, $id)
    {
        ...
        // Jika bukan, berarti ini dari form submission di halaman detail. Lakukan redirect.
