        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table id="izin-table" class="min-w-full dt-tailwindcss divide-y divide-gray-200">
    ...
    @push('scripts')
        ...
        <script>
            function confirmDelete(id, nama) {
                Swal.fire({
                    title: 'Yakin ingin menghapus izin?',
                    text: `Pengajuan izin untuk ${nama} akan dihapus!`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        fetch(`/izin/${id}`, { // Sesuaikan URL dengan route Anda
                            method: 'DELETE',
                            headers: {
                            ...
                            if (response.ok) {
                                window.izinTable.ajax.reload(null, false);
                                Swal.fire({
                                    title: 'Berhasil!',
                                    text: 'Data pengajuan izin berhasil dihapus.',
                                    icon: 'success',
                                    timer: 2000,
            ...
            $(document).ready(function() {
                ...
                window.izinTable = $('#izin-table').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                            ...
                            render: function(data, type, row) {
                                ...
                                switch (data) {
                                    case 'Satu Hari':
                                        ...
                                        break;
                                    case 'Setengah Hari Pagi':
                                        badgeClass = 'text-cyan-800 bg-cyan-100';
                                        break;
                                    case 'Setengah Hari Siang':
