        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table id="sakit-table" class="min-w-full dt-tailwindcss divide-y divide-gray-200">
        ...
        <script>
            function confirmDelete(id, nama) {
                Swal.fire({
                    ...
                    text: `Pengajuan sakit untuk ${nama} akan dihapus!`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        fetch(`/sakit/${id}`, { // Sesuaikan URL dengan route Anda
                            method: 'DELETE',
                            headers: {
                            ...
                            if (response.ok) {
                                window.sakitTable.ajax.reload(null, false);
                                Swal.fire({
                                    title: 'Berhasil!',
                                    text: 'Data pengajuan sakit berhasil dihapus.',
                                    icon: 'success',
                                    timer: 2000,
