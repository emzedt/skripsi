        ...
        <div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700 mt-14">
            <x-slot name="header">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Laporan Absensi Sales') }}
                </h2>
            </x-slot>

            <div class="bg-white p-6 rounded-lg shadow-md">
                <form action="{{ route('reports.absensi_sales.excel') }}" method="GET" class="mb-4">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <a href="{{ route('reports.absensi_sales.pdf') }}"
                ...
                <form id="pdf-form" action="{{ route('reports.absensi_sales.pdf') }}" method="GET" class="hidden">
