            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-end mb-4">
                        <a href="{{ route('status_karyawan.create') }}"
                    ...
                    <table id="status-karyawan-table" class="min-w-full dt-tailwindcss divide-y divide-gray-200">
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                return `<div class="flex space-x-2">
                                            ...
                                            <button type="button" onclick="confirmDelete(${data}, '${row.status_karyawan}')" class="text-red-600 hover:text-red-900" title="Delete">
                ...
                window.statusKaryawanTable = table;
            });

            function confirmDelete(id, name) {
                Swal.fire({
                    title: 'Hapus Data',
                    text: `Anda yakin ingin menghapus status ${name}?`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        fetch(`/status_karyawan/${id}`, { // Sesuaikan URL dengan route Anda
                            method: 'DELETE',
                            headers: {
                            ...
                            if (response.ok) {
                                window.statusKaryawanTable.ajax.reload(null, false);
                                Swal.fire({
                                    title: 'Berhasil!',
